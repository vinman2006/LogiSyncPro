    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl rounded-2xl border border-border bg-card p-6 md:p-8 shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-border pb-4 mb-6">
          <div>
            <span className="text-[10px] font-bold uppercase tracking-wider text-brand">Multi-Rail Settlement Gateway</span>
            <h2 className="text-xl font-bold text-foreground">Settle Shipment {shipment.readable_id}</h2>
          </div>
        ...
        {successInfo ? (
          <div className="text-center py-6 space-y-4 animate-in zoom-in-95 duration-200">
            ...
            <div>
              <h3 className="text-lg font-bold text-foreground">Payment Verified & Settled</h3>
            ...
            {successInfo.transactionHash && (
              <div className="rounded-xl border border-border bg-muted/30 p-3 text-left">
                ...
                <div className="font-mono text-xs break-all font-semibold text-foreground">
                  {successInfo.transactionHash}
                </div>
              </div>
            )}
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-full rounded-xl bg-brand py-3 text-sm font-semibold text-brand-foreground shadow hover:opacity-95"
            >
          ...
          <div>
            ...
            <div className="space-y-2.5 mb-6">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-foreground">Razorpay Test Checkout</span>
                ...
                {selectedMethod === 'RAZORPAY' && <CheckCircle2 className="h-5 w-5 text-brand" />}
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-foreground">MetaMask (EVM Testnet)</span>
                ...
                {selectedMethod === 'METAMASK' && <CheckCircle2 className="h-5 w-5 text-brand" />}
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-foreground">Stellar Network (Testnet)</span>
                ...
                {selectedMethod === 'STELLAR' && <CheckCircle2 className="h-5 w-5 text-brand" />}
              </button>
            </div>
            ...
            <button
              ...
              onClick={handlePay}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-brand py-3.5 text-sm font-semibold text-brand-foreground shadow hover:opacity-95 disabled:opacity-50 transition-all mb-4"
            >
            ...
            <div className="border-t border-border pt-4">
              <div className="flex items-center justify-between">
                <span className="text-xs text-muted-foreground">Need instantaneous demo approval?</span>
                <button
                  type="button"
                  disabled={isProcessing}
                  onClick={() => {
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-dashed border-amber-500/40 bg-amber-500/10 text-amber-800 dark:text-amber-300 text-xs font-bold hover:bg-amber-500/20 transition-all"
                >
                  <span>⚡ Demo: Mark as Paid</span>
                  <span className="text-[9px] px-1 py-0.2 rounded bg-amber-500/20 uppercase font-extrabold">
                    DEMO ONLY
                  </span>
                </button>
              </div>
